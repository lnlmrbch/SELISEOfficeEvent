...
let rollingNumberTimer = null;
let rollingProgressTimer = null;
let rollingStopTimeout = null;
...
function setActivePhaseDot(index) {
...
function scheduleReturnToStartScreen() {
  clearStartScreenTimeout();
  clearResultCountdownTimer();
...
function persistNextTicket(value) {
